...
public struct SubscriptionService {
  ...
  public static func fetchAll(for accountID: Int) async throws -> [SubscriptionDTO] {
  ...
  public static func create(accountID: Int, body: SubscriptionDTO) async throws -> SubscriptionDTO {
    return try await NetworkService.sendRequest(
  ...
  public static func update(subscriptionID: Int, body: SubscriptionDTO) async throws -> SubscriptionDTO {
    return try await NetworkService.sendRequest(
