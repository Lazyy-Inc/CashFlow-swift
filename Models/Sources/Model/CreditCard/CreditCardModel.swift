...
public struct CreditCardModel: Codable, Identifiable, Equatable, Hashable {
    ...
    public var expirateDate: String
    public var limitByMonth: Double?

    // Initialiseur
    public init(id: Int? = nil, uuid: UUID? = nil, holder: String, number: String, cvc: String, expirateDate: String, limitByMonth: Double? = nil) {
        self.id = id
        self.uuid = uuid
        self.holder = holder
        self.number = number
